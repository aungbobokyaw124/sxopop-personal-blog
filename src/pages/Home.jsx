...
function SxopopMark() {
  return (
    <div className="hero-mark" aria-hidden="true">
      ...
      <div className="mark-core"><img src="/assets/icon.png"< alt="SXOPOP" /></div>
...
export default function Home() {
  ...
  return (
    <main className="home-page">
      <section className="home-hero grid-bg">
        ...
        <div className="hero-inner">
          <div className="hero-copy">
            ...
            <p className="hero-description reveal">နည်းပညာကို လက်တွေ့အသုံးချ၍ အသုံးဝင်သော digital products, systems နှင့် knowledge များကို ဖန်တီးတည်ဆောက်ပေးပြီး အတွေ့အကြုံ၊ နည်းပညာနှင့် အတွေးအမြင်များကို စုစည်းမှတ်တမ်းတင်ထားသည့် personal platform ဖြစ်ပါတယ်။</p>
      ...
      <section className="section-shell intro-section"><div className="intro-grid reveal"><div className="section-kicker">01 / About</div><div><h2 className="section-lead">Technology is a tool.<br /><span className="muted">Creating useful things is the purpose.</span></h2><p className="section-copy">ကျွန်တော်တို့အတွက် နည်းပညာဆိုတာ အသုံးချဖို့အတွက်သာမက ပြဿနာတွေကို ပိုမိုကောင်းမွန်တဲ့နည်းလမ်းနဲ့ ဖြေရှင်းဖို့အစားထိုးနိုင်တဲ့ ကိရိယာတစ်ခုပါ။ Website, AI, electronics, automation နှင့် digital services တွေကို လေ့လာ၊ စမ်းသပ်၊ တည်ဆောက်ရင်း ရရှိလာတဲ့ လက်တွေ့အသိပညာတွေကို ဒီ Blog မှာ မျှဝေထားပါတယ်။</p><Link to="/about" className="text-link">Discover my story <span>↗</span></Link></div></div></section>
